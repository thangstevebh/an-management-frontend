    ...
    <div className="relative m-auto h-48 w-80 rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-xl transition-transform sm:h-56 sm:w-96 sm:hover:scale-110">
      <div className="absolute top-4 w-full px-8 sm:top-8">
        ...
        <div className="pt-1 flex justify-between">
          <div>
            <p className="font-light">Số cuối</p>
          ...
          <div>
            <p className="font-light">Cộng tác viên</p>
            <p className="tracking-more-wider font-medium">{colloborator}</p>
          </div>
        </div>
        <div className="pt-4 pr-6 sm:pt-6">
          <div className="flex justify-between">
            <div className="">
              <p className="text-xs font-light">Bắt đầu</p>
              <p className="text-base font-medium tracking-widest">
                {validFrom}
              </p>
            </div>
            <div className="">
              <p className="text-xs font-light">Hạn</p>
              <p className="text-base font-medium tracking-widest">{expiry}</p>
            </div>

            <div className="">
              <p className="text-xs font-light">CVV</p>
              <p className="tracking-more-wider text-sm font-bold">{cvv}</p>
            </div>
          </div>
        </div>
      </div>
